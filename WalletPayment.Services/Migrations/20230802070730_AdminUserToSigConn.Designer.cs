...
namespace WalletPayment.Services.Migrations
{
    ...
    [Migration("20230802070730_AdminUserToSigConn")]
    partial class AdminUserToSigConn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WalletPayment.Models.Entites.SignalrConnection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WalletPayment.Models.Entites.SignalrConnection", b =>
                {
                    b.HasOne("WalletPayment.Models.Entites.Admins", "AdminsUser")
                        .WithMany("AdminUserSignalrConnections")
                        .HasForeignKey("AdminUserId");

                    b.HasOne("WalletPayment.Models.Entites.User", "User")
                        .WithMany("UserSignalrConnections")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AdminsUser");
            ...
            modelBuilder.Entity("WalletPayment.Models.Entites.Admins", b =>
                {
                    b.Navigation("AdminUserSignalrConnections");
                });
            ...
            modelBuilder.Entity("WalletPayment.Models.Entites.User", b =>
                {
                    ...
                    b.Navigation("UserSignalrConnections");
                });
