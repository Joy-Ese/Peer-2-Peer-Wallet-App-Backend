...
namespace WalletPayment.Services.Migrations
{
    ...
    [Migration("20230823103425_UserToUserChat")]
    partial class UserToUserChat
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WalletPayment.Models.Entites.UserToUserChat", b =>
                {
                    b.HasOne("WalletPayment.Models.Entites.User", "RecipientUser")
                        .WithMany()
                        .HasForeignKey("RecipientUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WalletPayment.Models.Entites.User", "SenderUser")
                        .WithMany()
                        .HasForeignKey("SenderUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WalletPayment.Models.Entites.User", null)
                        .WithMany("UserToUserChats")
                        .HasForeignKey("UserId");
