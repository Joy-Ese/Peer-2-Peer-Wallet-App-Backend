...
namespace WalletPayment.Services.Migrations
{
    public partial class InitialFirst : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PaystackDeposits",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StatusMessage = table.Column<int>(type: "int", nullable: false),
                    PaystackDepositStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PaystackReference = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PaystackEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PaystackAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PaystackCurrency = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaystackDeposits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaystackDeposits_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaystackDeposits_UserId",
                table: "PaystackDeposits",
                column: "UserId");
